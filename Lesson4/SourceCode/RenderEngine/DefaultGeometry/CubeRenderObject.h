...
class RENDERENGINE_API SmallCubeRenderObject final : public RenderObject
{
public:
	SmallCubeRenderObject(RenderProxy * pRenderProxy);

	virtual void* GetVertices() const override { return (void*)s_smallcubeVertices; }
	virtual UINT32 GetVerticesSize() const override { return sizeof(s_smallcubeVertices); }
	virtual void* GetIndices() const override { return (void*)s_smallcubeTriList; }
	virtual UINT32 GetIndicesSize() const override { return sizeof(s_smallcubeTriList); }
	virtual std::string GetVsShaderName() const override { return "vs_cubes"; }
	virtual std::string GetPsShaderName() const override { return "fs_cubes"; }

private:
	inline static const PosColorVertex s_smallcubeVertices[] =
	{
	...
	inline static const uint16_t s_smallcubeTriList[] =
	{
		0, 1, 2, // 0
		1, 3, 2,
		4, 6, 5, // 2
